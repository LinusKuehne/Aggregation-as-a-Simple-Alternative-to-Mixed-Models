...
results.ri.vio2 <- data.frame(left.ri.ci = ci.left.ri, right.ri.ci = ci.right.ri, left.agg.ci = ci.left.agg,
                              right.agg.ci = ci.right.agg, mean.ri = est.means.ri, mean.agg = est.means.agg)

save(results.ri.vio2, file = "data_ri_vio2.rda")
...
pdf("ci_ri_plot_vio2.pdf", width=7, height=7)
