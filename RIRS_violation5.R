...
results.rirs.vio5 <- data.frame(left.rirs.ci = ci.left.rirs, right.rirs.ci = ci.right.rirs, left.agg.ci = ci.left.agg,
                                right.agg.ci = ci.right.agg, mean.rirs = est.means.rirs, mean.agg = est.means.agg)

save(results.rirs.vio5, file = "data_rirs_vio5.rda")
...
pdf("ci_rirs_plot_vio5.pdf", width=7, height=7)
